...
<head>
    <meta charset="UTF-8">
    <title>Welcome all to Jenkins </title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
</head>
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome all to</h1>
      ...
      <h2 class="text-center">Welcome to Shilpa,Sandeep,Naresh and shwetha, sriyasi on behalf Ram Sir from Infinito Solutions</h2>
